...
**A:** Supported HDMI resolutions depend on the **board model (RDK X3, X5, etc.), SoC, and RDK OS version**.
...
* **Specific models/versions:**
    ...
    * Higher-end boards (RDK X5) may support higher resolutions (e.g., 4K).
* **How to check:**
