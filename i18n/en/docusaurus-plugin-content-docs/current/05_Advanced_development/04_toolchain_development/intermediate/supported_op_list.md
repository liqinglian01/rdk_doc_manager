...
- On RDK X5 and other BAYES/BAYES_E BPU platforms, operators follow the usual constraints: 1. Input and output dimensions are 4D unless an op explicitly supports non-four-dimensional cases; 2. shape: H, W, C ∈ [1, 65536], N ≤ 4096, and N × C × H × W ≤ 1 GB; 3. Caffe 1.0 base and common extended operators and ONNX opsets 10–11 are supported; ops that do not meet BPU constraints fall back to the ARM CPU.
...
| **ONNX Operator Name** | **CPU/BPU acceleration** | **X5 BPU constraints** | **CPU Constraints** |
| ----------------- | --------------------- | --------------------------- | ------------------ |
